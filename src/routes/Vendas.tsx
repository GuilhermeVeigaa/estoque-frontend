  ...
  return (
    <main>
        <header className="bg-red-700 h-20 w-full flex justify-evenly">
            <h1 className="text-2xl font-bold text-center text-white pt-4">Entadas e Saídas</h1>
        </header>

        <section className="w-full">
            <h1 className="text-center text-5xl text-blue-500 mt-20">Coming Soon</h1>

            <p className="mt-20">Desculpa não consegui desenvolver essa parte.</p>
